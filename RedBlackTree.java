...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    /**
     * This method sets the parent child relation between the replaced
     * nodes and completes the correctness of the tree.
     * @param grandParent the main root for this subtree
     * @param parent the new replaced parent node
     * @param child the new replaced child node
     */
    private void relationSet(Node<T> grandParent, Node <T> parent, Node <T> child){
        if (grandParent == null) { // checks if the root of the subtree is null
            root = child;
        } else if (grandParent.context[1] == parent) { // if parent node is a left child
            grandParent.context[1] = child;
        } else if (grandParent.context[2] == parent) { // if parent  node is a right child
            grandParent.context[2] = child;
        } else { // throws an exception if no relation found
            throw new IllegalStateException("Input nodes not related");
        }
        // sets the new child node to the root of the subtree
        if (child != null) {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        // throws exception if parent and child not related
        if(!child.context[0].equals(parent)){
            throw new IllegalArgumentException("No parent child relation");
        }
       ...
       if(!child.isRightChild()){
        ...
        relationSet(grandParent, parent, child);
    }
    ...
    /**
     * This tester method tests the rotate method for within the tree rotations.
     *
     * @return True if the new tree matches the expected one, false otherwise.
     */
    public static boolean test1() {
        // TODO: Implement this test.
        RedBlackTree<Integer> tree = new RedBlackTree<Integer>(); // tree object
        // insert statements to generate nodes in the tree
        tree.insert(4);
        tree.insert(2);
        tree.insert(6);
        tree.insert(1);
        ...
        // assigning node positions to integers which will be rotated
        Node<Integer> three = tree.findNodeWithData(3);
        Node<Integer> two = tree.findNodeWithData(2);
    ...
    /**
     * This tester method tests the rotate method for root level left rotations.
     *
     * @return True if the new tree matches the expected one, false otherwise.
     */
    public static boolean test2() {
        ...
        Node<Integer> seven = tree.findNodeWithData(7);
        Node<Integer> nine = tree.findNodeWithData(9);

        tree.rotate(seven,nine);

        if(!tree.toLevelOrderString().equals("[ 7, 5, 9 ]")) {
            return false;
        }
        return true;
    }
    ...
    /**
     *This tester method tests the rotate method for root level right rotations.
     *
     * @return True if the new tree matches the expected one, false otherwise.
     */
    public static boolean test3() {
        ...
        Node<Integer> seven = tree.findNodeWithData(7);
        Node<Integer> five = tree.findNodeWithData(5);

        tree.rotate(seven,five);
